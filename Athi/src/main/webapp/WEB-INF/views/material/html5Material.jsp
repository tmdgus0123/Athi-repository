   ...
   <div class="container">
      ...
      <div class="col-sm-12" style="margin-top: 50px; margin-bottom: 50px;">
         <div class="col-sm-12 text-center" style="background-color: white; border-radius: 1em; padding-top: 25px; padding-bottom: 10px; opacity: 0.85;">
            ...
            <div>
               <iframe src=https://www.youtube.com/embed/OGFgdro160I?list=PLuHgQVnccGMDUzDDCKW-pCZQY-MMCX5yB style="width: 100%; height: 475px;"> </iframe>
            </div>
            <div style="margin-top: 25px; margin-bottom: 25px;">출처 : https://www.youtube.com/embed/OGFgdro160I?list=PLuHgQVnccGMDUzDDCKW-pCZQY-MMCX5yB</div>
         </div>
      </div>
   </div>
