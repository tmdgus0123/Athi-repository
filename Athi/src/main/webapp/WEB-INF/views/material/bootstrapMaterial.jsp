	...
	<div class="container">
		...
		<div class="col-sm-12" style="margin-top: 50px; margin-bottom: 50px;">
			<div class="col-sm-12 text-center" style="background-color: white; border-radius: 1em; padding-top: 25px; padding-bottom: 10px; opacity: 0.85;">
				...
				<div>
					<iframe src="https://www.youtube.com/embed/HKtD3d9C69U?list=PLMWJA4FwmYz0_Lkeafmikle2Mpzt4lqIl" style="width: 100%; height: 475px;"> </iframe>
				</div>
				<div style="margin-top: 25px; margin-bottom: 25px;">출처 : https://www.youtube.com/embed/HKtD3d9C69U?list=PLMWJA4FwmYz0_Lkeafmikle2Mpzt4lqIl</div>
			</div>
		</div>
	</div>
